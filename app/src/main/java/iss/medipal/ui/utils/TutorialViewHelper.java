...
public class TutorialViewHelper {
    ...
    public static float getScrollX(View view) {
        return AnimatorProxy.NEEDS_PROXY?(float)AnimatorProxy.wrap(view).getScrollX(): TutorialViewHelper.Honeycomb.getScrollX(view);
    }
    ...
    public static float getScrollY(View view) {
        return AnimatorProxy.NEEDS_PROXY?(float)AnimatorProxy.wrap(view).getScrollY(): TutorialViewHelper.Honeycomb.getScrollY(view);
    }
